...
export function WineCard({ wine, onAddToCart, onClick, priority = false }: WineCardProps) {
	...
	return (
		<article
			className="overflow-hidden cursor-pointer h-full flex flex-col bg-gradient-to-b from-white to-red-50 border border-red-100 hover:border-red-300 rounded-lg sm:mx-auto w-full transition-all duration-300 relative"
